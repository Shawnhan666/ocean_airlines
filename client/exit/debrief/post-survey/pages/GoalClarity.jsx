...
export default class GoalClarity extends Component {
  state = {
    name: "goalClarity",
  }
  ...
  render() {
    ...
    const questions = [
      "The goal and objectives of the slogan task",
      "What aspects of our work will lead to positive evaluations in the slogan task",
    ]
